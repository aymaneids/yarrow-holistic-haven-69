      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="order-2 md:order-1">
          <img
            ...
            alt="Relaxation Station interior"
        ...
        <div className="order-1 md:order-2 animate-slideInRight">
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            Welcome to Relaxation Station, Charleston's premier non-toxic salon suite. We're committed to providing exceptional hair services with organic, sustainable products that nurture your hair while respecting our planet.
          </p>
          
          <p className="text-gray-600 mb-6 leading-relaxed">
            Our philosophy embraces holistic beauty—recognizing that true beauty stems from health, sustainability, and mindful practices. Every service at Relaxation Station is designed with your wellbeing and environmental impact in consideration.
          </p>
