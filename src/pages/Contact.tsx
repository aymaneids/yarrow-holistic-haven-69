...
import { MapPin, Clock, Facebook, ArrowRight } from "lucide-react";
const Contact = () => {
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="space-y-8 mb-10">
              ...
              <div className="flex items-start">
                <Facebook className="h-6 w-6 mr-4 mt-1 text-yarrow-sage" />
                <div>
                  <h3 className="font-medium text-xl text-gray-800 mb-2">Social Media</h3>
                  <a href="https://www.facebook.com/CMRelaxationStation" target="_blank" rel="noopener noreferrer" className="text-yarrow-sage hover:text-yarrow-moss transition-colors duration-300 font-medium text-lg">Christina Nikki Martin</a>
                </div>
              </div>
            </div>
            ...
            <div className="mt-10">
              ...
              <p className="text-gray-600 mb-6">
                Ready to experience holistic beauty at Relaxation Station? Book your appointment online through our Vagaro scheduling system.
              </p>
          ...
          <div className="h-[500px] rounded-lg overflow-hidden shadow-lg">
            ...
            border: 0
          }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Relaxation Station Location"></iframe>
          </div>
        </div>
      </section>
